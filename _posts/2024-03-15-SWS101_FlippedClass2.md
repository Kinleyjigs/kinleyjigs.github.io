...
#### Learning Through the crocodile Machine
* File Include (LFI) vulnerability:
...
### Three 
#### Gaining Access to the system
I spawn, ping and scan the machine like usual.
![croc8](/assets/img/three/scan.png)
---
Title: SWS101 Flipped_class
categories: [SWS101,Flipped_2]
tags: SWS 101
...
#### Gaining Access to the System
like befor
e i spawn the machine and got the target ip address of dancing machine.In my scan 3 ports are detected.The port 445/tcp is open and running on microsoft-ds which includes SMB functionality.
